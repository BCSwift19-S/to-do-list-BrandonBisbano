...
//    var toDoArray = ["Do Macro Theory Homework",
//                     "Soccer Practice 6:00 p.m.",
//                     "Change the World!"]
//    var toDoNotesArray = ["6:00 tomorrow night",
//                          "Bring a ball",
//                          "Use a pen"]
    ...
    @IBAction func editBarButtonPressed(_ sender: UIBarButtonItem) {
        if tableView.isEditing {
            ...
            plusBarButton.isEnabled = true
        } else {
            tableView.setEditing(true, animated: true)
            editBarButton.title = "Done"
            plusBarButton.isEnabled = false
        }
    }
}
